...
export const UserEditStyles = styled.div`
...
export const UserEditHeader = styled.h5`
...
export const UserEditInputAndLabelGrid = styled.div`
  display: grid;
  grid-template-rows: repeat(2, max-content);
`;

export const UserEditCheckedAndLabelGrid = styled.div`
  display: grid;
  grid-template-columns: repeat(2, max-content);
  column-gap: 2rem;
`;

export const UserEditLabel = styled.label`
  display: block;
...
export const UserEditCheckBox = styled.input`
  width: 2rem;
  height: 2rem;
  border: 1px solid transparent;
  background-color: ${({ theme }) => theme.colors.black.two};
